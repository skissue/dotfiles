...
Mark messages read upon trashing them (since, if I trashed it, I don't want to be bothered by it anymore). Implementation based on [[help:mu4e-marks][mu4e-marks]].
#+begin_src elisp
  (after! mu4e
